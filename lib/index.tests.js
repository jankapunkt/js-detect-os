...
describe('windows', function () {
  const run = getRunner(OSDetector.types.windows, { version: /10\.0/, isMobile: false })
...
describe('macos', function () {
  describe('mojave', function () {
    const run = getRunner(OSDetector.types.macos, { version: /10\.14.*/, name: 'Mojave', isMobile: false })
...
describe('ios', function () {
  const run = getRunner(OSDetector.types.ios, { version: /12\.1\.3/, isMobile: true })
